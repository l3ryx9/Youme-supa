...
echo ""
echo "  3. Générez un build de développement (une fois par appareil) :"
echo ""
echo "     ${BOLD}eas build --profile development --platform android${RESET}"
echo "     ${BOLD}eas build --profile development --platform ios${RESET}"
echo ""
echo "  4. Lancez l'application (build de dev requis — pas Expo Go) :"
echo ""
echo "     ${BOLD}npx expo start --dev-client${RESET}  # Démarrage local"
